...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        new File(WORKSPACE_DIRECTORY + subDir).mkdirs();
        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(new File(WORKSPACE_DIRECTORY + subDir + filename)), "UTF-8");
    ...
    public String getAuthorEmail() {
        return "jerome.moret@heig-vd.ch";
    }
